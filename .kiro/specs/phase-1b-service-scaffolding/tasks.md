...
- [ ] 1. Set up Common Library (court-booking-common)
  - [ ] 1.1 Create Maven project structure with pom.xml
    - Create `court-booking-common/pom.xml` with groupId `gr.courtbooking`, artifactId `court-booking-common`, Java 21
    - Configure Spring Boot starter dependencies as `provided` scope
    - Add Jackson, JUnit 5, AssertJ, and jqwik dependencies
    - Configure `distributionManagement` for GitHub Packages
    - _Requirements: 1.1, 1.2, 1.3, 1.4_

  - [ ] 1.2 Implement DTO enum types
    - [ ] 1.2.1 Create CourtType enum (TENNIS, PADEL, BASKETBALL, FOOTBALL_5X5)
      - _Requirements: 2.2_
    - [ ] 1.2.2 Create LocationType enum (INDOOR, OUTDOOR)
      - _Requirements: 2.2_
    - [ ] 1.2.3 Create BookingStatus enum (PENDING_CONFIRMATION, CONFIRMED, CANCELLED, COMPLETED, REJECTED)
      - _Requirements: 2.2_
    - [ ] 1.2.4 Create PaymentStatus enum (NOT_REQUIRED, PENDING, AUTHORIZED, CAPTURED, REFUNDED, PARTIALLY_REFUNDED, FAILED, PAID_EXTERNALLY)
      - _Requirements: 2.2_
    - [ ] 1.2.5 Create UserRole enum (CUSTOMER, COURT_OWNER, SUPPORT_AGENT, PLATFORM_ADMIN)
      - _Requirements: 2.2_
    - [ ] 1.2.6 Create DayOfWeekEnum enum (MONDAY through SUNDAY)
      - _Requirements: 2.2_
    - [ ] 1.2.7 Create Language enum (EL, EN)
      - _Requirements: 2.2_

  - [ ] 1.3 Implement DTO record classes
    - [ ] 1.3.1 Create CourtSummaryDto record with Jackson annotations
      - _Requirements: 2.1, 2.3, 2.4_
    - [ ] 1.3.2 Create UserBasicDto record with Jackson annotations
      - _Requirements: 2.1, 2.3, 2.4_
    - [ ] 1.3.3 Create BookingDto record with monetary fields using Cents suffix
      - _Requirements: 2.1, 2.3, 2.4_
    - [ ] 1.3.4 Create PaymentDto record with monetary fields using Cents suffix
      - _Requirements: 2.1, 2.3, 2.4_
    - [ ] 1.3.5 Create PricingRuleDto record
      - _Requirements: 2.1, 2.3, 2.4_

  - [ ]* 1.4 Write property test for DTO JSON serialization (Property 1)
    - **Property 1: DTO JSON Serialization Produces camelCase Field Names**
    - **Validates: Requirements 2.3**

  - [ ]* 1.5 Write property test for monetary field naming convention (Property 2)
    - **Property 2: Monetary Fields Use Cents Suffix Convention**
    - **Validates: Requirements 2.4**

  - [ ] 1.6 Implement Kafka event infrastructure
    - [ ] 1.6.1 Create EventEnvelope<T> generic record with validation
      - _Requirements: 3.1, 3.2_
    - [ ] 1.6.2 Create KafkaTopics constants class with all topic names
      - _Requirements: 3.1_

  - [ ] 1.7 Implement booking event payload classes
    - [ ] 1.7.1 Create BookingCreatedPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.7.2 Create BookingConfirmedPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.7.3 Create BookingCancelledPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.7.4 Create BookingModifiedPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.7.5 Create BookingCompletedPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.7.6 Create SlotHeldPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.7.7 Create SlotReleasedPayload record
      - _Requirements: 3.3, 3.4_

  - [ ] 1.8 Implement notification event payload classes
    - [ ] 1.8.1 Create NotificationRequestedPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.8.2 Create NotificationData record
      - _Requirements: 3.3, 3.4_

  - [ ] 1.9 Implement court update event payload classes
    - [ ] 1.9.1 Create CourtUpdatedPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.9.2 Create PricingUpdatedPayload record with nested PricingRule record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.9.3 Create AvailabilityUpdatedPayload record with nested DateRange and Override records
      - _Requirements: 3.3, 3.4_
    - [ ] 1.9.4 Create CancellationPolicyUpdatedPayload record with nested Tier record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.9.5 Create CourtDeletedPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.9.6 Create StripeConnectStatusChangedPayload record
      - _Requirements: 3.3, 3.4_

  - [ ] 1.10 Implement match event payload classes
    - [ ] 1.10.1 Create MatchCreatedPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.10.2 Create MatchUpdatedPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.10.3 Create MatchClosedPayload record
      - _Requirements: 3.3, 3.4_

  - [ ] 1.11 Implement waitlist event payload classes
    - [ ] 1.11.1 Create WaitlistSlotFreedPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.11.2 Create WaitlistHoldExpiredPayload record
      - _Requirements: 3.3, 3.4_

  - [ ] 1.12 Implement analytics event payload classes
    - [ ] 1.12.1 Create BookingAnalyticsPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.12.2 Create RevenueAnalyticsPayload record
      - _Requirements: 3.3, 3.4_
    - [ ] 1.12.3 Create PromoCodeRedeemedPayload record
      - _Requirements: 3.3, 3.4_

  - [ ] 1.13 Implement security event payload classes
    - [ ] 1.13.1 Create SecurityAlertPayload record with nested AlertMetadata record
      - _Requirements: 3.3, 3.4_

  - [ ]* 1.14 Write property test for event serialization round-trip (Property 3)
    - **Property 3: Event Payload Serialization Round-Trip**
    - **Validates: Requirements 3.4, 3.5**

  - [ ] 1.15 Implement exception classes
    - [ ] 1.15.1 Create CourtBookingException base class with errorCode and httpStatus fields
      - _Requirements: 4.1, 4.2_
    - [ ] 1.15.2 Create ResourceNotFoundException subclass (404)
      - _Requirements: 4.1, 4.2_
    - [ ] 1.15.3 Create ConflictException subclass (409)
      - _Requirements: 4.1, 4.2_
    - [ ] 1.15.4 Create ValidationException subclass (400)
      - _Requirements: 4.1, 4.2_
    - [ ] 1.15.5 Create UnauthorizedException subclass (401)
      - _Requirements: 4.1, 4.2_
    - [ ] 1.15.6 Create ForbiddenException subclass (403)
      - _Requirements: 4.1, 4.2_

  - [ ] 1.16 Implement utility classes
    - [ ] 1.16.1 Create MoneyUtil class with add, subtract, multiplyByPercentage methods
      - _Requirements: 4.3_
    - [ ] 1.16.2 Add calculatePlatformFee and calculateNetAmount methods to MoneyUtil
      - _Requirements: 4.3_
    - [ ] 1.16.3 Create ErrorResponse record for consistent API error responses
      - _Requirements: 4.4_

  - [ ]* 1.17 Write property tests for MoneyUtil arithmetic (Property 4)
    - **Property 4: MoneyUtil Arithmetic Correctness**
    - **Validates: Requirements 4.3**

  - [ ] 1.18 Create GitHub Actions CI workflow for common library
...
- [ ] 2. Checkpoint - Common Library Complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 3. Set up Platform Service (court-booking-platform-service)
  - [ ] 3.1 Create Maven project structure with pom.xml
    - Create `court-booking-platform-service/pom.xml` with Spring Boot 3.x parent, Java 21
    ...
    - Configure maven-surefire-plugin for JUnit 5 and jqwik
    - _Requirements: 6.1, 6.2, 23.1, 23.2, 23.3, 23.4, 23.5_

  - [ ] 3.2 Create hexagonal architecture package structure
    - [ ] 3.2.1 Create domain packages (domain/model, domain/exception, domain/service)
      - _Requirements: 6.3_
    - [ ] 3.2.2 Create application packages (application/port/in, application/port/out, application/service)
      - _Requirements: 6.3_
    - [ ] 3.2.3 Create adapter/in packages (adapter/in/web, adapter/in/kafka)
      - _Requirements: 6.3_
    - [ ] 3.2.4 Create adapter/out packages (adapter/out/persistence, adapter/out/kafka, adapter/out/redis)
      - _Requirements: 6.3_
    - [ ] 3.2.5 Create config package
      - _Requirements: 6.3_

  - [ ] 3.3 Create Spring Boot main application class
    - Create `PlatformServiceApplication` with `@SpringBootApplication` annotation
    - _Requirements: 6.4_

  - [ ] 3.4 Create placeholder health info controller
    - Create `HealthInfoController` at `/api/health/info` returning service name and version
    - _Requirements: 6.5_

  - [ ] 3.5 Configure Spring profiles - shared defaults
    - [ ] 3.5.1 Create application.yml with JPA, Flyway, Actuator, springdoc defaults
      - _Requirements: 9.1_
    - [ ] 3.5.2 Configure Hibernate Spatial dialect for PostGIS
      - _Requirements: 9.1_
    - [ ] 3.5.3 Configure graceful shutdown settings
      - _Requirements: 26.1, 26.3, 26.6_

  - [ ] 3.6 Configure Spring profiles - local environment
    - [ ] 3.6.1 Create application-local.yml with localhost PostgreSQL connection (port 5432)
      - _Requirements: 9.3_
    - [ ] 3.6.2 Configure local Redis connection (port 6379)
      - _Requirements: 9.3_
    - [ ] 3.6.3 Configure local Kafka connection (port 9092)
      - _Requirements: 9.3_
    - [ ] 3.6.4 Set server port to 8081 for local development
      - _Requirements: 9.3_

  - [ ] 3.7 Configure Spring profiles - dev environment
    - [ ] 3.7.1 Create application-dev.yml with environment variable placeholders
      - _Requirements: 9.5_
    - [ ] 3.7.2 Configure platform_service database user
      - _Requirements: 9.5, 25.1_

  - [ ] 3.8 Configure Spring profiles - test environment
    - [ ] 3.8.1 Create application-test.yml with environment variable placeholders
      - _Requirements: 9.7_
    - [ ] 3.8.2 Configure platform_service database user
      - _Requirements: 9.7, 25.1_

  - [ ] 3.9 Configure Spring profiles - staging environment
    - [ ] 3.9.1 Create application-staging.yml with environment variable placeholders
      - _Requirements: 9.9_
    - [ ] 3.9.2 Configure platform_service database user
      - _Requirements: 9.9, 25.1_

  - [ ] 3.10 Configure Spring profiles - production environment
    - [ ] 3.10.1 Create application-prod.yml with environment variable placeholders
      - _Requirements: 9.10_
    - [ ] 3.10.2 Configure platform_service database user
      - _Requirements: 9.10, 25.1_
    - [ ] 3.10.3 Disable Swagger UI in prod profile
      - _Requirements: 31.5_

  - [ ] 3.11 Configure Spring Boot Actuator health endpoints
    - [ ] 3.11.1 Configure liveness probe at `/actuator/health/liveness`
      - _Requirements: 8.1_
    - [ ] 3.11.2 Configure readiness probe at `/actuator/health/readiness` with db, redis, kafka checks
      - _Requirements: 8.2_
    - [ ] 3.11.3 Configure startup probe at `/actuator/health`
      - _Requirements: 8.3_
    - [ ] 3.11.4 Configure health endpoint exposure settings
      - _Requirements: 8.7_

  - [ ] 3.12 Configure structured JSON logging
    - [ ] 3.12.1 Create logback-spring.xml with console appender for local profile
      - _Requirements: 27.1, 27.4_
    - [ ] 3.12.2 Configure JSON encoder appender for cloud profiles (dev, test, staging, prod)
      - _Requirements: 27.1, 27.2_
    - [ ] 3.12.3 Include MDC fields: traceId, spanId, requestId, userId, service
      - _Requirements: 27.2_
    - [ ] 3.12.4 Configure log levels per profile
      - _Requirements: 27.5_

  - [ ] 3.13 Implement RequestIdFilter for MDC logging
    - Create filter to extract `X-Request-ID` header and store in MDC
    - _Requirements: 27.3_

  - [ ]* 3.14 Write property test for structured log entries (Property 5)
    - **Property 5: Structured Log Entries Contain Required Fields**
    - **Validates: Requirements 27.1, 27.2, 27.3**

  - [ ] 3.15 Configure OpenAPI/springdoc
    - [ ] 3.15.1 Create OpenApiConfig class with API info
      - _Requirements: 31.1, 31.2_
    - [ ] 3.15.2 Configure API docs path at /v3/api-docs
      - _Requirements: 31.3_
    - [ ] 3.15.3 Configure Swagger UI path at /swagger-ui.html
      - _Requirements: 31.4_

  - [ ] 3.16 Implement global exception handler
    - Create `GlobalExceptionHandler` with `@RestControllerAdvice`
    - Map domain exceptions to HTTP responses with ErrorResponse
    - _Requirements: 4.4_

- [ ] 4. Set up Transaction Service (court-booking-transaction-service)
  - [ ] 4.1 Create Maven project structure with pom.xml
    - Create `court-booking-transaction-service/pom.xml` with Spring Boot 3.x parent, Java 21
  ...
  - [ ] 4.2 Create hexagonal architecture package structure
    - [ ] 4.2.1 Create domain packages (domain/model, domain/exception, domain/service)
      - _Requirements: 7.3_
    - [ ] 4.2.2 Create application packages (application/port/in, application/port/out, application/service)
      - _Requirements: 7.3_
    - [ ] 4.2.3 Create adapter/in packages (adapter/in/web, adapter/in/kafka, adapter/in/websocket)
      - _Requirements: 7.3_
    - [ ] 4.2.4 Create adapter/out packages (adapter/out/persistence, adapter/out/kafka, adapter/out/redis, adapter/out/stripe)
      - _Requirements: 7.3_
    - [ ] 4.2.5 Create config package
      - _Requirements: 7.3_

  - [ ] 4.3 Create Spring Boot main application class
    - Create `TransactionServiceApplication` with `@SpringBootApplication` annotation
    - _Requirements: 7.4_

  - [ ] 4.4 Create placeholder health info controller
    - Create `HealthInfoController` at `/api/health/info` returning service name and version
    - _Requirements: 7.5_

  - [ ] 4.5 Configure Spring profiles - shared defaults
    - [ ] 4.5.1 Create application.yml with JPA, Flyway, Actuator, springdoc defaults
      - _Requirements: 9.2_
    - [ ] 4.5.2 Configure Quartz scheduler settings for clustered mode
      - _Requirements: 28.1, 28.2, 28.3_
    - [ ] 4.5.3 Configure graceful shutdown settings
      - _Requirements: 26.2, 26.4, 26.6_

  - [ ] 4.6 Configure Spring profiles - local environment
    - [ ] 4.6.1 Create application-local.yml with localhost PostgreSQL connection
      - _Requirements: 9.4_
    - [ ] 4.6.2 Configure local Redis connection
      - _Requirements: 9.4_
    - [ ] 4.6.3 Configure local Kafka connection
      - _Requirements: 9.4_
    - [ ] 4.6.4 Set server port to 8082 for local development
      - _Requirements: 9.4_
    - [ ] 4.6.5 Configure Flyway to target transaction schema
      - _Requirements: 9.4_

  - [ ] 4.7 Configure Spring profiles - dev environment
    - [ ] 4.7.1 Create application-dev.yml with environment variable placeholders
      - _Requirements: 9.6_
    - [ ] 4.7.2 Configure transaction_service database user
      - _Requirements: 9.6, 25.2_

  - [ ] 4.8 Configure Spring profiles - test environment
    - [ ] 4.8.1 Create application-test.yml with environment variable placeholders
      - _Requirements: 9.8_
    - [ ] 4.8.2 Configure transaction_service database user
      - _Requirements: 9.8, 25.2_

  - [ ] 4.9 Configure Spring profiles - staging environment
    - [ ] 4.9.1 Create application-staging.yml with environment variable placeholders
      - _Requirements: 9.9_
    - [ ] 4.9.2 Configure transaction_service database user
      - _Requirements: 9.9, 25.2_

  - [ ] 4.10 Configure Spring profiles - production environment
    - [ ] 4.10.1 Create application-prod.yml with environment variable placeholders
      - _Requirements: 9.10_
    - [ ] 4.10.2 Configure transaction_service database user
      - _Requirements: 9.10, 25.2_
    - [ ] 4.10.3 Disable Swagger UI in prod profile
      - _Requirements: 31.5_

  - [ ] 4.11 Configure Spring Boot Actuator health endpoints
    - [ ] 4.11.1 Configure liveness probe at `/actuator/health/liveness`
      - _Requirements: 8.4_
    - [ ] 4.11.2 Configure readiness probe at `/actuator/health/readiness`
      - _Requirements: 8.5_
    - [ ] 4.11.3 Configure startup probe at `/actuator/health`
      - _Requirements: 8.6_

  - [ ] 4.12 Configure Quartz Scheduler for clustered mode
    - [ ] 4.12.1 Configure JDBC job store with isClustered=true
      - _Requirements: 28.1, 28.2_
    - [ ] 4.12.2 Set instanceId=AUTO for unique scheduler instance IDs
      - _Requirements: 28.3_
    - [ ] 4.12.3 Configure thread pool with configurable thread count
      - _Requirements: 28.4, 28.5_

  - [ ] 4.13 Configure structured JSON logging
    - [ ] 4.13.1 Create logback-spring.xml with console appender for local profile
      - _Requirements: 27.1, 27.4_
    - [ ] 4.13.2 Configure JSON encoder appender for cloud profiles
      - _Requirements: 27.1, 27.2_

  - [ ] 4.14 Implement RequestIdFilter for MDC logging
    - Create filter to extract `X-Request-ID` header and store in MDC
    - _Requirements: 27.3_

  - [ ] 4.15 Configure OpenAPI/springdoc
    - [ ] 4.15.1 Create OpenApiConfig class with API info
      - _Requirements: 31.1, 31.2_
    - [ ] 4.15.2 Configure API docs and Swagger UI paths
      - _Requirements: 31.3, 31.4_

  - [ ] 4.16 Implement global exception handler
    - Create `GlobalExceptionHandler` with `@RestControllerAdvice`
    - _Requirements: 4.4_

- [ ] 5. Checkpoint - Service Scaffolding Complete
  - Ensure all tests pass, ask the user if questions arise.


- [ ] 6. Create Flyway Database Migrations - Platform Service
  - [ ] 6.1 Create Platform Service V1 migration - Enable PostGIS
    - Create `src/main/resources/db/migration/platform/V1__create_platform_schema.sql`
    - Enable PostGIS extension
    - _Requirements: 10.1_

  - [ ] 6.2 Create Platform Service V1 migration - Users and authentication tables
    - [ ] 6.2.1 Create users table with all columns and constraints
      - _Requirements: 10.2_
    - [ ] 6.2.2 Create indexes on users table (email, role, status, stripe_connect, stripe_customer)
      - _Requirements: 10.3_
    - [ ] 6.2.3 Create oauth_providers table with unique constraint
      - _Requirements: 10.2_
    - [ ] 6.2.4 Create refresh_tokens table with indexes
      - _Requirements: 10.2_
    - [ ] 6.2.5 Create verification_requests table with indexes
      - _Requirements: 10.2_

  - [ ] 6.3 Create Platform Service V1 migration - Courts table
    - [ ] 6.3.1 Create courts table with PostGIS geometry column
      - _Requirements: 10.2_
    - [ ] 6.3.2 Create GIST index on courts.location for spatial queries
      - _Requirements: 10.3_
    - [ ] 6.3.3 Create indexes on courts (owner_id, court_type, location_type, visible)
      - _Requirements: 10.3_
    - [ ] 6.3.4 Create composite index on courts (court_type, location_type) WHERE visible = TRUE
      - _Requirements: 10.3_

  - [ ] 6.4 Create Platform Service V1 migration - Availability tables
    - [ ] 6.4.1 Create availability_windows table with CHECK constraint on end_time > start_time
      - _Requirements: 10.2, 10.4_
    - [ ] 6.4.2 Create availability_overrides table with indexes
      - _Requirements: 10.2_
    - [ ] 6.4.3 Create holiday_templates table with unique index
      - _Requirements: 10.2_
    - [ ] 6.4.4 Create court_holiday_subscriptions table with unique constraint
      - _Requirements: 10.2_
    - [ ] 6.4.5 Add FK from availability_overrides to holiday_templates
      - _Requirements: 10.2_

  - [ ] 6.5 Create Platform Service V1 migration - User preferences tables
    - [ ] 6.5.1 Create favorites table with composite primary key
      - _Requirements: 10.2_
    - [ ] 6.5.2 Create preferences table with user_id as primary key
      - _Requirements: 10.2_
    - [ ] 6.5.3 Create skill_levels table with composite primary key and CHECK constraint
      - _Requirements: 10.2, 10.4_

  - [ ] 6.6 Create Platform Service V1 migration - Pricing tables
    - [ ] 6.6.1 Create pricing_rules table with CHECK constraint on multiplier range
      - _Requirements: 10.2, 10.4_
    - [ ] 6.6.2 Create special_date_pricing table with unique index
      - _Requirements: 10.2_
    - [ ] 6.6.3 Create cancellation_tiers table with unique index on court_id, threshold_hours
      - _Requirements: 10.2_

  - [ ] 6.7 Create Platform Service V1 migration - Promo codes tables
    - [ ] 6.7.1 Create promo_codes table with CHECK constraints
      - _Requirements: 10.2, 10.4_
    - [ ] 6.7.2 Create promo_code_redemptions table with unique index
      - _Requirements: 10.2_

  - [ ] 6.8 Create Platform Service V1 migration - Support tables
    - [ ] 6.8.1 Create support_tickets table with CHECK constraints and indexes
      - _Requirements: 10.2, 10.4_
    - [ ] 6.8.2 Create support_messages table with index on ticket_id
      - _Requirements: 10.2_
    - [ ] 6.8.3 Create support_attachments table with index on message_id
      - _Requirements: 10.2_

  - [ ] 6.9 Create Platform Service V1 migration - Court owner tables
    - [ ] 6.9.1 Create court_owner_audit_logs table with indexes
      - _Requirements: 10.2_
    - [ ] 6.9.2 Create reminder_rules table with CHECK constraint and indexes
      - _Requirements: 10.2, 10.4_
    - [ ] 6.9.3 Create court_owner_notification_preferences table with unique index
      - _Requirements: 10.2_
    - [ ] 6.9.4 Create court_defaults table
      - _Requirements: 10.2_

  - [ ] 6.10 Create Platform Service V1 migration - Security tables
    - [ ] 6.10.1 Create security_alerts table with CHECK constraints
      - _Requirements: 10.2, 10.4_
    - [ ] 6.10.2 Create indexes on security_alerts (status, severity, user_id, ip_address, type)
      - _Requirements: 10.3_
    - [ ] 6.10.3 Create ip_blocklist table with indexes
      - _Requirements: 10.2_
    - [ ] 6.10.4 Create failed_auth_attempts table with indexes
      - _Requirements: 10.2_

  - [ ] 6.11 Create Platform Service V1 migration - Misc tables
    - [ ] 6.11.1 Create translations table with unique index on key, language
      - _Requirements: 10.2_
    - [ ] 6.11.2 Create feature_flags table with unique constraint on flag_key
      - _Requirements: 10.2_
    - [ ] 6.11.3 Create court_ratings table with unique index on booking_id
      - _Requirements: 10.2_

  - [ ] 6.12 Create Platform Service V2 migration - Cross-schema views
    - [ ] 6.12.1 Create v_court_summary view
      - _Requirements: 10.5_
    - [ ] 6.12.2 Create v_user_basic view
      - _Requirements: 10.5_
    - [ ] 6.12.3 Create v_court_cancellation_tiers view
      - _Requirements: 10.5_
    - [ ] 6.12.4 Create v_user_skill_level view
      - _Requirements: 10.5_
    - [ ] 6.12.5 Grant SELECT on views to transaction_service role
      - _Requirements: 10.5_

- [ ] 7. Create Flyway Database Migrations - Transaction Service
  - [ ] 7.1 Create Transaction Service V1 migration - Bookings table
    - [ ] 7.1.1 Create bookings table with all columns and CHECK constraints
      - _Requirements: 11.1, 11.4_
    - [ ] 7.1.2 Create indexes on bookings (court_id, user_id, date, status, court_owner_id)
      - _Requirements: 11.3_
    - [ ] 7.1.3 Create EXCLUDE constraint for non-overlapping bookings
      - _Requirements: 11.4_

  - [ ] 7.2 Create Transaction Service V1 migration - Payments table
    - [ ] 7.2.1 Create payments table with CHECK constraints
      - _Requirements: 11.1, 11.4_
    - [ ] 7.2.2 Create indexes on payments (booking_id, user_id, status, stripe_payment_intent_id)
      - _Requirements: 11.3_

  - [ ] 7.3 Create Transaction Service V1 migration - Audit logs table
    - [ ] 7.3.1 Create audit_logs table with CHECK constraint on actor_type
      - _Requirements: 11.1, 11.4_
    - [ ] 7.3.2 Create indexes on audit_logs (entity_type, entity_id, actor_id, created_at)
      - _Requirements: 11.3_

  - [ ] 7.4 Create Transaction Service V1 migration - Notifications table
    - [ ] 7.4.1 Create notifications table with CHECK constraints
      - _Requirements: 11.1, 11.4_
    - [ ] 7.4.2 Create indexes on notifications (user_id, status, created_at)
      - _Requirements: 11.3_
    - [ ] 7.4.3 Create device_tokens table with unique constraint
      - _Requirements: 11.1_

  - [ ] 7.5 Create Transaction Service V1 migration - Waitlist table
    - [ ] 7.5.1 Create waitlists table with CHECK constraint on status
      - _Requirements: 11.1, 11.4_
    - [ ] 7.5.2 Create indexes on waitlists (court_id, date, user_id, status)
      - _Requirements: 11.3_

  - [ ] 7.6 Create Transaction Service V1 migration - Open matches tables
    - [ ] 7.6.1 Create open_matches table with CHECK constraints
      - _Requirements: 11.1, 11.4_
    - [ ] 7.6.2 Create indexes on open_matches (court_id, date, status, creator_user_id)
      - _Requirements: 11.3_
    - [ ] 7.6.3 Create match_players table with unique constraint
      - _Requirements: 11.1_
    - [ ] 7.6.4 Create match_join_requests table with CHECK constraint
      - _Requirements: 11.1, 11.4_
    - [ ] 7.6.5 Create match_messages table with index
      - _Requirements: 11.1_

  - [ ] 7.7 Create Transaction Service V1 migration - Split payments tables
    - [ ] 7.7.1 Create split_payments table with CHECK constraint on status
      - _Requirements: 11.1, 11.4_
    - [ ] 7.7.2 Create split_payment_shares table with CHECK constraint
      - _Requirements: 11.1, 11.4_
    - [ ] 7.7.3 Create indexes on split_payment_shares (split_payment_id, user_id)
      - _Requirements: 11.3_

  - [ ] 7.8 Create Transaction Service V2 migration - Quartz tables
    - [ ] 7.8.1 Create QRTZ_JOB_DETAILS table
      - _Requirements: 11.5_
    - [ ] 7.8.2 Create QRTZ_TRIGGERS table with FK to JOB_DETAILS
      - _Requirements: 11.5_
    - [ ] 7.8.3 Create QRTZ_SIMPLE_TRIGGERS table with FK to TRIGGERS
      - _Requirements: 11.5_
    - [ ] 7.8.4 Create QRTZ_CRON_TRIGGERS table with FK to TRIGGERS
      - _Requirements: 11.5_
    - [ ] 7.8.5 Create QRTZ_SIMPROP_TRIGGERS table with FK to TRIGGERS
      - _Requirements: 11.5_
    - [ ] 7.8.6 Create QRTZ_BLOB_TRIGGERS table with FK to TRIGGERS
      - _Requirements: 11.5_
    - [ ] 7.8.7 Create QRTZ_CALENDARS table
      - _Requirements: 11.5_
    - [ ] 7.8.8 Create QRTZ_PAUSED_TRIGGER_GRPS table
      - _Requirements: 11.5_
    - [ ] 7.8.9 Create QRTZ_FIRED_TRIGGERS table
      - _Requirements: 11.5_
    - [ ] 7.8.10 Create QRTZ_SCHEDULER_STATE table
      - _Requirements: 11.5_
    - [ ] 7.8.11 Create QRTZ_LOCKS table
      - _Requirements: 11.5_
    - [ ] 7.8.12 Create all Quartz indexes (idx_qrtz_j_req_recovery, idx_qrtz_j_grp, idx_qrtz_t_j, etc.)
      - _Requirements: 11.5_

- [ ] 8. Checkpoint - Database Migrations Complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 9. Create Dockerfiles
  - [ ] 9.1 Create Platform Service Dockerfile
    - [ ] 9.1.1 Create build stage with Maven 3.9 and Eclipse Temurin 21
      - _Requirements: 12.1, 12.3_
    - [ ] 9.1.2 Copy pom.xml first for dependency caching
      - _Requirements: 12.4_
  ...
  - [ ] 9.2 Create Transaction Service Dockerfile
    - [ ] 9.2.1 Create build stage with Maven 3.9 and Eclipse Temurin 21
      - _Requirements: 12.2, 12.3_
    - [ ] 9.2.2 Copy pom.xml first for dependency caching
      - _Requirements: 12.4_
...
- [ ] 16. Create CI/CD Pipelines - Platform Service CI Workflow
  ...
  - [ ] 16.3 Configure CI workflow steps
    - [ ] 16.3.1 Add checkout step
      - _Requirements: 13.2_
    - [ ] 16.3.2 Add Java 21 setup step with Maven cache
      - _Requirements: 13.2_
...
- [ ] 17. Create CI/CD Pipelines - Platform Service Deploy Workflow
  ...
  - [ ] 17.2 Create build-and-push job
    - [ ] 17.2.1 Configure checkout and Java 21 setup steps
      - _Requirements: 13.3_
    - [ ] 17.2.2 Add Maven build step (mvn clean package -DskipTests)
      - _Requirements: 13.3_
...
- [ ] 18. Create CI/CD Pipelines - Transaction Service CI Workflow
  ...
  - [ ] 18.3 Configure CI workflow steps
    - [ ] 18.3.1 Add checkout step
      - _Requirements: 14.2_
    - [ ] 18.3.2 Add Java 21 setup step with Maven cache
      - _Requirements: 14.2_
...
- [ ] 22. Create Repository Documentation
  - [ ] 22.1 Create Platform Service README.md
    - [ ] 22.1.1 Add project overview section
      - _Requirements: 30.1_
    - [ ] 22.1.2 Add prerequisites section (Java 21, Maven, Docker)
      - _Requirements: 30.1_
  ...
  - [ ] 22.3 Create Common Library README.md
    ...
    - [ ] 22.3.2 Add build and publish instructions
      - _Requirements: 30.3_
    - [ ] 22.3.3 Add Maven dependency consumption guide with GitHub Packages authentication
      - _Requirements: 30.3_
